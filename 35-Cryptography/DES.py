# Python implementation of DES supporting plaintext of at least 1000 characters
...
# DES encryption for a single block
...
def des_encrypt(plaintext, key):
    ...
    # Pad plaintext to multiple of 64 bits
    ...
    for i in range(0, len(padded_plaintext), 8):
        ...
        encrypted_block = des_encrypt_block(binary_block, keys)
